// todo: spin off as a module (async of course)? https://github.com/fs-utils/symlink/blob/master/index.js
// currently this is a asynchronous blocking mess, because pasted together from different older snippets.
...
function isAbsolute(_path) {
	return path.resolve(_path) === path.normalize(_path).replace(/[\/|\\]$/, '');
}